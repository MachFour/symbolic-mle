...
from models.normal import normal_symbols_variance_mle, normal_symbols_mean_mle
from models.uniform import normal_symbols_heuristic_min_max
from symbols.normal import NormalSymbol
from utils import make_axis_values


def plot_normal_normal_fitting(symbols: tuple[NormalSymbol]):
    """
